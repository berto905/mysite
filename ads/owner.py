...
class OwnerCreateView(LoginRequiredMixin, CreateView):
    """
    Sub-class to the CreateView to automatically pass the Request to the Form
...
class OwnerUpdateView(LoginRequiredMixin, UpdateView):
    """
    Sub-class to the UpdateView to pass the request to the form and
    limit the queryset to the requesting user.
    """

    def get_query_set(self):
        print('update get_query_set called')
...
class OwnerDeleteView(LoginRequiredMixin, DeleteView):
    """
    Sub-class the DeleteView to restrict a User from deleting
    other user's data.
    """
