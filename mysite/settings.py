...
# Used for a default title          # LS: new line from Ads assignment
APP_NAME = 'ChucksList'             # LS: new line from Ads assignment

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/3.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
# SECRET_KEY = 'whn&li9%0t=v1ncy#j=mdn+zp7m1oard9bl7fj1_oj1vnzgwk!'  # Old line
...
INSTALLED_APPS = [
    ...
    'django.contrib.humanize',      # LS: new line from Ads assignment
    ...
    'unesco.apps.UnescoConfig',      #LS: new line for Unesco assignment


    # Sample Applications - don't copy
    # 'polls.apps.PollsConfig',       # LS: old line
    # 'autos.apps.AutosConfig',       # LS: old line
    # 'cats.apps.CatsConfig',         # LS: old line
...
CRISPY_TEMPLATE_PACK = 'bootstrap3'  # Add  # LS: new line from Ads assignment
...
# Starting from this line is new lines from Ads assignment
